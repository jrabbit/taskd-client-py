...
class TestTaskdResponse(unittest.TestCase):
    ...
    def test_properties(self):
        payload = ['{"description":"hang up posters","entry":"20141130T081652Z","status":"pending","uuid":"0037aa92-45e5-44a6-8f34-2f92989f173a"}',
        ...
        self.assertEqual(self.resp.sync_key, "bdf5e970-e337-4023-9d28-ee85e2291b40")
